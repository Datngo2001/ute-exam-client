            ...
            <div className="accordion-item mb-2">
                <h2 className="accordion-header" id={`heading${prop.groupId}`}>
                    <button
                        ...
                        data-bs-target={`#collapse${prop.groupId}`}
                        aria-expanded="false"
                        aria-controls={`collapse${prop.groupId}`}
                    >
                        <span>
                ...
                <div
                    id={`collapse${prop.groupId}`}
                    className="accordion-collapse collapse"
                    aria-labelledby={`heading${prop.groupId}`}
                >
                    <div className="accordion-body">{navLinkElements}</div>
                </div>
            </div>
        </div>
    )
